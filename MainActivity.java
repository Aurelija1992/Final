...
public class MainActivity extends AppCompatActivity {
    ...
    TextView tv_score, tv_questions, tv_timer, tv_buttonmesage;
...
CountDownTimer timer = new CountDownTimer( 30000, 1000) {
    ...
    public void onFinish() {
        ...
        tv_buttonmesage.setText("Time is up!" + g.getNumberCorrect() + "/" + (g.getTotalQuestions() -1));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_buttonmesage = findViewById(R.id.tv_buttonmesage);
        ...
        tv_buttonmesage.setText("Press Go");
        tv_score.setText("0Points");
        ...
        private void nextTurn () {
           ...
           tv_buttonmesage.setText(g.getNumberCorrect() + "/" + ( g.getTotalQuestions() -1 ));
